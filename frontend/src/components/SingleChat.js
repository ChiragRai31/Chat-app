...
import backgroundImage from '../../src/wallapaper.jpeg'
      ...
      {selectedChat ? (
        <>
          ...
          <Box
            ...
            bg="#57534E"
            w="100%"
            style={{ backgroundImage : ` linear-gradient(rgba(87, 83, 78, 0.9), rgba(87, 83, 78, 0.9)), url(${backgroundImage})`}}
